    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 animate-in slide-in-from-left-4 duration-500">
            ...
            <div>
                ...
                <div className="bg-white p-8  border border-slate-100 shadow-sm max-w-2xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <select
                                value={formData.activityLevel || 1.2} // default is 1.2 if undefined
                                onChange={(e) =>
                                    handleChange('activityLevel', parseFloat(e.target.value))
                                }
                                className="w-full px-4 py-2 border border-slate-300 focus:ring-2 focus:ring-emerald-500 outline-none"
                            >
                    ...
                    <div className="bg-emerald-50 p-6 border border-emerald-100 flex items-center justify-between">
                        <div>
                    ...
                    <button
                        onClick={handleSave}
                        disabled={loading}
                        className={`mt-8 w-full py-4 text-white font-bold  transition shadow-lg shadow-emerald-100 ${loading ? 'bg-emerald-400 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-700'}`}
                    >
