            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 border border-slate-100 shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        {pantry.map(item => (
                            <span key={item} className="flex items-center gap-2 px-3 py-1.5 bg-slate-100 text-slate-700 rounded-lg text-sm font-medium border border-slate-200">
                                {item}
                                <button onClick={() => removeFromPantry(item)} className="text-slate-400 hover:text-red-500 transition">
                                    <Trash2 size={14} />
                                </button>
                            </span>
                        ))}
